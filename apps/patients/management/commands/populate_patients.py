...
class Command(BaseCommand):
    ...
    FIRST_NAMES_MALE = [
        "Juan", "Jose", "Miguel", "Carlos", "Antonio", "Rafael", "Marco",
        "Gabriel", "Daniel", "David", "Luis", "Fernando", "Ricardo", "Eduardo",
        "Roberto", "Alejandro", "Francisco", "Manuel", "Pedro", "Ramon",
    ]

    FIRST_NAMES_FEMALE = [
        "Maria", "Ana", "Sofia", "Isabella", "Camila", "Valentina", "Lucia",
        "Elena", "Carmen", "Rosa", "Patricia", "Gloria", "Teresa", "Cristina",
        "Angela", "Beatriz", "Laura", "Diana", "Sandra", "Monica",
    ]

    MIDDLE_NAMES = [
        "Santos", "Cruz", "Reyes", "Garcia", "Martinez", "Lopez", "Dela Cruz",
        "Ramos", "Bautista", "Villanueva", "Gonzales", "Mendoza", "Aquino", "",
    ]

    LAST_NAMES = [
        "Santos", "Reyes", "Cruz", "Garcia", "Mendoza", "Lopez", "Gonzales",
        "Villanueva", "Ramos", "Bautista", "Aquino", "Fernandez", "Torres",
        "Rivera", "Flores", "Castillo", "Morales", "Navarro", "Pascual", "Mercado",
    ]

    CITIES = [
        "Manila", "Quezon City", "Makati", "Pasig", "Taguig", "Cebu City",
        "Davao City", "Caloocan", "Las Pinas", "Paranaque", "Muntinlupa",
    ]
    ...
    STREETS = [
        "123 Rizal St.", "456 Mabini Ave.", "789 Bonifacio Blvd.",
        "321 Luna St.", "654 Del Pilar Rd.", "987 Aguinaldo Highway",
        "147 Quezon Ave.", "258 Osmeña St.", "369 Roxas Blvd.", "741 EDSA",
    ]

    ALLERGIES = [
        ["Penicillin"], ["Sulfa drugs"], ["Aspirin"], ["Ibuprofen"],
        ["Shellfish"], ["Peanuts"], ["Latex"], ["Bee stings"],
        ["Penicillin", "Sulfa drugs"], ["Aspirin", "Ibuprofen"],
        [], [], [], [],  # Empty for variety
    ]
    ...
    MEDICAL_CONDITIONS = [
        ...
        ["Hypothyroidism"], ["GERD"], ["Migraine"], ["Anxiety"],
        [], [], [], [],  # Empty for variety
    ]
